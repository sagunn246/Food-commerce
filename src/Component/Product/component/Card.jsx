...
const Card = ({ data }) => {
  ...
  return (
    <>
      <div
        className="my-2 flex h-auto flex-col items-center border border-gray-400 rounded-lg shadow-md w-72 overflow-hidden gap-1 hover:shadow-lg hover:shadow-black/50 transition-shadow duration-300 hover:bg-slate-50 cursor-pointer"
          ...
          <div className="flex justify-between items-center mt-auto">
            ...
            <button
              ...
              className={`flex items-center gap-2 ${
                cartbool ? "bg-blue-500 hover:bg-blue-600" : "bg-orange-500 hover:bg-orange-600"
